...
export class CompareAll {
    static __wrap(ptr) {
        const obj = Object.create(CompareAll.prototype);
        obj.__wbg_ptr = ptr;
        CompareAllFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        CompareAllFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_compareall_free(ptr, 0);
    }
    /**
     * @returns {number}
     */
    get pixel_diff_ratio() {
        const ret = wasm.compareall_pixel_diff_ratio(this.__wbg_ptr);
        return ret;
    }
    /**
     * @returns {number}
     */
    get psnr() {
        const ret = wasm.compareall_psnr(this.__wbg_ptr);
        return ret;
    }
    /**
     * @returns {number}
     */
    get ssim() {
        const ret = wasm.compareall_ssim(this.__wbg_ptr);
        return ret;
    }
    /**
     ...
     */
    take_diff() {
        const ret = wasm.compareall_take_diff(this.__wbg_ptr);
...
export function cluster_group(images, strictness, threshold) {
    ...
    const ret = wasm.cluster_group(images, ptr0, len0, isLikeNone(threshold) ? Number.MAX_SAFE_INTEGER : (threshold) >>> 0);
    if (ret[2]) {
 ...
 * @returns {CompareAll}
 */
export function compare_all(a, b, width, height, tolerance) {
